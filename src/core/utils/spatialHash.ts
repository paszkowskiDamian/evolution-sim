...
/** Wynik wyszukiwania najbliższego obiektu — obiekt reużywalny, bez alokacji. */
...
export function makeNearestResult(): NearestResult {
  return { id: -1, dx: 0, dy: 0, dist2: 0, found: false };
}

/** Znajduje najbliższy obiekt w promieniu, opcjonalnie pomijając `excludeId`. */
export function queryNearest(
  ...
  out.dx = 0;
  out.dy = 0;
  grid.forEachInRadius(x, y, radius, (id, dx, dy, d2) => {
